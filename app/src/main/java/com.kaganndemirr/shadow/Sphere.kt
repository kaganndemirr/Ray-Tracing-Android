...
class Sphere: Shape{
    ...
    constructor(center: Vertex, radius: Int, ambient: Double, diffuse: Double, specular: Double, reflection: Double, transmitted: Double, refraction: Double, shapeColor: Color){
        this.center = center
        this.radius = radius
