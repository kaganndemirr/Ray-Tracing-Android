...
class Sphere: Shape{
    ...
    constructor(center: Vertex, radius: Double, ambient: Double, diffuse: Double, specular: Double, reflection: Double, transmitted: Double, refraction: Double, shapeColor: Color){
        this.center = center
        this.radius = radius
